...
<html lang="en">
<head>
	<title>Registrarse musiKdi</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100 bg-light">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action = "php/insertUser.php" class="login100-form validate-form" method="POST" >
					<span class="login100-form-title p-b-49">
						Registrarse
					</span>
					<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
					<?php
					$register = $_GET["varRegister"];
					if($register=='S'){  //login exitoso ?>
					<div class="flex-col-c">
						<p><i class="zmdi zmdi-badge-check zmdi-hc-5x"></i></p>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Apellido es requerido">
						...
						<input class="input100" type="text" name="lastname" placeholder="Ingrese su apellido">
						
					</div>

					<div class="wrap-input100 validate-input m-b-23" data-validate = "El correo es requerido">
						<span class="label-input100">Correo</span>
						<input class="input100" type="email" name="mail" placeholder="Ingrese su correo">
						<span class="focus-input100" data-symbol="&#xf15a;"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-23" data-validate = "El nombre de usuario es requerido">
						<span class="label-input100">Nombre de usuario</span>
						<input class="input100" type="text" name="username" placeholder="Ingrese nombre de usuario">
						<span class="focus-input100" data-symbol="&#xf1ff;"></span>
					</div>
