...
<main role="main">
  ...
  <div class="container">
    ...
    <div class="row mx-auto">
      <h1 class="ppbold">Perfil</h1>
    </div>
    <div class="row justify-content-md-center align-items-center">
     
      <div class = "col-md-2 col-md-offset-5">
        <h3><?php echo $name; ?> </h3>
        <p><b>País:</b> <?php echo $response["Pais"];?><br>
        <b>Visitas:</b> <?php echo $response["Busquedas"];?></p>
        
      </div>
      <div class="col-md-3 col-md-offset-5">
        <img width = "65%" class ="img-thumbnail rounded-circle" src="<?php echo $response["imgurl"];?>">
      </div>
    </div>
    ...
    <div class="row mt-5 mx-auto">
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"><?php include "gapi/profileArtistSP.php";?></div>
        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><?php include "gapi/profileArtistYT.php";?></div>
      </div>
